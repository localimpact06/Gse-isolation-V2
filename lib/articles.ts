...
export const articles: Article[] = [
  {
    ...
    sections: [
      ...
      { h2: "Comment l'obtenir sans se tromper", texte: "La demande se fait en ligne, avant de signer le moindre devis, avec des documents conformes aux exigences du dispositif. L'erreur classique ? Commencer les travaux avant validation du dossier. Résultat : l'aide tombe à l'eau, même après coup. Notre équipe vous accompagne de la simulation au suivi administratif." },
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: "Pourquoi le faire même sans obligation", texte: "Sans audit, on isole souvent au hasard : on traite un poste secondaire avant la vraie source de déperdition. L'audit de projet permet d'identifier où votre logement perd de l'énergie, et dans quel ordre agir." },
      { h2: "Ce qui se passe concrètement", texte: "Un spécialiste analyse votre logement, vos équipements de chauffage et de ventilation, et vos habitudes de consommation. L'échange peut commencer par téléphone ou en visio, puis être complété par une visite technique selon le projet." },
      ...
      { h2: "Audit réglementaire ou audit de projet : pas pareil", texte: "L'audit obligatoire pour vendre un bien F ou G doit être réalisé par un professionnel spécifiquement certifié, avec un format encadré par la loi. L'audit de projet prépare les travaux et les priorités budgétaires. Les deux ne se remplacent pas si vous êtes en démarche de vente." },
      { h2: "Le coût d'un audit réglementaire", texte: "Un audit réglementaire facturé par un bureau d'études indépendant coûte généralement entre 500 et 1 000€ — à anticiper si vous prévoyez de vendre un bien classé F ou G." },
    ],
  },
  {
    ...
    sections: [
      ...
      { h2: "La démarche, en pratique", texte: "On dépose la demande auprès d'une banque conventionnée, avec un devis et les documents techniques requis par le dispositif. On vous aide à rassembler les pièces nécessaires pour monter le dossier bancaire sans accroc." },
